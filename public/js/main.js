    ...
    for(var i=0; i<3; i++){
        ...
        for(var j = 0; j<4; j++){
            ...
            const result =`<div class="column">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><strong>${title}</strong>${subtitle}</h5>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><strong>Author(s):</strong> ${author}</li>
                            <li class="list-group-item"><strong>Page Count:</strong> ${pageCount}</li>
                            <li class="list-group-item"><strong>Rating: </strong>${rating}</li>
                            <li class="list-group-item"><button type="button" class="save btn btn-link"><strong>Save to Wishlist</strong></button></li>
                            ${purchasable}`;
